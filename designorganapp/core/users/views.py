...
class UserListView(LoginRequiredMixin, ValidatePermissionRequiredMixin, ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['list_url'] = reverse_lazy('user:user-list')
        return context
...
class UserDeleteView(LoginRequiredMixin, ValidatePermissionRequiredMixin, DeleteView):
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context['title'] = 'Eliminar Registro de un Usuario'
        context['nav_clients'] = 'Cliente'
        context['nav_productions'] = 'Producción'
        context['nav_sale'] = 'Ventas'
        context['entity'] = 'Usuarios'
...
class UserChangePasswordView(LoginRequiredMixin, FormView):
    ...
    def get_form(self, form_class=None):
        ...
        form.fields['new_password2'].widget.attrs['placeholder'] = 'Confirme su nueva contraseña'
        return form
